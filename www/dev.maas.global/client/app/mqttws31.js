...
//    	    	break;
    ...
    ClientImpl.prototype._doConnect = function (host, port) {
        ...
        if (this.connectOptions.useSSL)
            wsurl = ["wss://", host, ":", port, this.connectOptions.path||"/mqtt"].join("");
        else
            wsurl = ["ws://", host, ":", port, this.connectOptions.path||"/mqtt"].join("");
     ...
     * @param {string} clientId the Messaging client identifier, between 1 and 128 characters in length.
     *
    ...
    var Client = function (host, port, clientId) {
        ...
        if (typeof clientId !== "string" || clientIdLength < 1 | clientIdLength > 128) // AWS allows 128
