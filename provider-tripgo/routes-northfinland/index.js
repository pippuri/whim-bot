...
var TRIPGO_NORTH_FINLAND_ROUTING_URL = 'https://hadron-fi-northfinland.tripgo.skedgo.com/satapp/routing.json';
...
function getTripGoRoutes(from, to, format) {
  ...
  console.log(qs);
  return request.get(TRIPGO_NORTH_FINLAND_ROUTING_URL, {
    json: true,
    headers: {
