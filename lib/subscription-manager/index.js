...
function getLoginURL(identityId) {
  ...
  return Request.post(`${API_URL}/portal_sessions`, { json: true, auth: auth, form: { 'customer[id]': identityId, redirect_url: 'https://prod.maas.global/login' } }  );
}
