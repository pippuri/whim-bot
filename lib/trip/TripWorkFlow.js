...
module.exports = class TripWorkFlow {
  ...
  assignFlowInput(input) {
    ...
    this.stage = input.stage || this.stage || process.env.SERVERLESS_STAGE;
  ...
  assignDecisionTaskInput(data) {
    if (!this.assertType(data.workflowType)) {
      throw new Error(`Decider: unknown decision task: '${this.data.workflowType}'`);
    }
      ...
      for (let event of data.events) {
        ...
        switch (event.eventType) {
          ...
          case 'LambdaFunctionCompleted':
            ...
            this.assignFlowInput(result.input);
            this.event = event.eventType;
            return;
          ...
          case 'WorkflowExecutionStarted':
            ...
            result = event.workflowExecutionStartedEventAttributes
                     ...
                     || "{}";
            this.assignFlowInput(JSON.parse(result));
            this.event = event.eventType;
            return;
          default:
