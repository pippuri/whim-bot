...
module.exports = class TripWorkFlow {
  ...
  get startWorkflowExecutionParams() {
    ...
    const executionStartToCloseTimeout = (this.trip.endTime + (60 * 60 * 1000)) - Date.now();
    const tripFlowParams = Object.assign({}, this.coreFlowParams, {
      executionStartToCloseTimeout: String(Math.round(executionStartToCloseTimeout / 1000)),
