...
module.exports.create = function (params) {
  ...
  return Promise.resolve()
    .then(() => swfClient.startWorkflowExecution(flow.startWorkflowExecutionParams).promise())
    .then(data => {
...
module.exports.cancel = function (params) {
  ...
  // request flow cancel
  return swfClient.signalWorkflowExecution(flow.signalWorkflowExecutionParams)
    .promise()
    .then(data => {
...
module.exports.check = function (params) {
  ...
  // request
  return swfClient.signalWorkflowExecution(flow.signalWorkflowExecutionParams).promise()
    .then(data => {
