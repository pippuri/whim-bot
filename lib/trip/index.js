...
module.exports.cancel = function (params) {
  ...
  return swfClient.signalWorkflowExecutionAsync(flow.signalWorkflowExecutionParams)
    ...
    .then(data => {
      console.info(`Trip cancel successfull, workflow '${flow.id}' requested to cancel...`);
...
module.exports.startWithItinerary = function (itinerary) {
  ...
  .catch(err => {
    ...
    console.warn(`Warning; NO Trip work flow created for itinerary '${itinerary.id}', ignoring...`);
  });
...
module.exports.cancelWithItinerary = function (itinerary) {
  ...
  .catch(err => {
    ...
    console.warn(`Warning; NO Trip work flow cancelled for itinerary '${itinerary.id}', ignoring...`);
  });
