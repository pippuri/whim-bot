...
module.exports = class Decision {
  ...
  */
  scheduleLambdaTask(serviceName, event) {
    const decision = Object.assign({}, Decision_ScheduleLambdaFunctionDecisionTemplate);
  ...
  scheduleTimedTask(firedTime, taskName, taskParams) {
    const decision = Object.assign({}, Decision_StartTimerDecisionTemplate);
    decision.startTimerDecisionAttributes.timerId = `${taskName}-${firedTime}`;
   ...
   */
  abortFlow(reason) {
    const decision = Object.assign({}, Decision_FailWorkflowExecutionTemplate);
   ...
   */
  closeFlow() {
    const decision = Object.assign({}, Decision_CompleteWorkflowExecutionTemplate);
    this.decisions.push(decision);
  }
