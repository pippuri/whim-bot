...
// Symbolic Profile.paymentMethod.status values
const PAYMENT_METHOD_STATUS_VALID = 'valid';
const PAYMENT_METHOD_STATUS_INVALID = 'invalid';
...
class SubscriptionManager {
  ...
  static get PAYMENT_METHOD_STATUS_VALID() {
    return PAYMENT_METHOD_STATUS_VALID;
  }

  static get PAYMENT_METHOD_STATUS_INVALID() {
  ...
  static fromChargebeePaymentMethod(chargebeePaymentMethod, chargebeeCard) {
    ...
    const response = {
      ...
      status: PAYMENT_METHOD_STATUS_INVALID,
    };

    // Set the status based on the paymentMethod status.
    // card_deleted and card_expired events will have an empty paymentMethod
    // so will default to PAYMENT_METHOD_STATUS_INVALID
    switch (method.status) {
      case 'valid':
      case 'expiring':
        response.status = PAYMENT_METHOD_STATUS_VALID;
        break;
      default:
        response.status = PAYMENT_METHOD_STATUS_INVALID;
    }
