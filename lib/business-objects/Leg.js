...
class Leg {
  ...
  isTransport() {
    return (['BUS', 'TRAIN', 'TRAM', 'FERRY', 'SUBWAY', 'TAXI'].indexOf(this.leg.mode) !== -1);
  }
  ...
  */
  ...
  _searchReusableBooking() {
    ...
    return Promise.all([
      ...
      .then(([allBookings, optionsResult]) => {
   ...
   */
  get from() {
    return Object.assign({}, this.leg.from);
  }
   ...
   */
  get to() {
    return Object.assign({}, this.leg.to);
  }
