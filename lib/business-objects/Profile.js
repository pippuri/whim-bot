...
class Profile {
  ...
  static updateSubscription(identityId, planId, promoCode, skipUpdate) {
    console.info(`[Profile] Set new subscription '${planId}' for identity '${identityId}'`);
    ...
    return Profile.retrieve(identityId)
      ...
      .then(response => {
        ...
        const optionalParams = (chargebeeUpdate) ? {
        ...
        const update = Object.assign({}, params, optionalParams);
