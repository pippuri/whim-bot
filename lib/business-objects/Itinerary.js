...
class Itinerary {
   ...
   *
   * If input transaction is given, all database operations here are bound to this transaction. Whoever calls this create-method, must then commit or rollback the transaction! The transaction must be created with Itinerary.startTransaction() by caller.
   *
   * @param {object} transaction - Objection transaction object
   * @return {Promise -> Itinerary}
   */
