...
/**
 * A compare function designed to be used by Array.prototype.sort to sort an
 * array of objects by a date field, inn reverse chronological order (most recent first).
 *
 * This function is designed to be curried on the first parameter which specifies
 * the field name of the date field to compare.
 *
 * @param {String} field - The date field name in each object
 * @param {Object} a - The left hand side of the comparison
 * @param {Object} b - The right hand side of the comparison
 *
 * @return {Boolean} - The comparison beween the date fields of a and b
 */
const dateSortCompareDesc = field => (a, b) => {
